...
const PipBoy: React.FC = () => {
    ...
    const [apCharge, setApCharge] = useState(0);
    ...
    // Check if element is strictly scrollable
    ...
    useEffect(() => {
        const handleWheel = (e: WheelEvent) => {
            ...
            // Prevent navigation outside the menu boundaries
            if (
                currentIndex === 0 &&
                scrollAccumulator.current < 0
            ) {
            ...
            // Trigger navigation
            if (
                Math.abs(scrollAccumulator.current) >=
                SCROLL_THRESHOLD
            ) {
        ...
        const decay = () => {
            ...
            if (
                now - lastScrollTime.current > 100 &&
            ...
            case 'MAP':
                return (
                    <div className="flex gap-6 mb-4 text-xl overflow-x-auto scrollbar-hide opacity-50 cursor-default">
                        <span className="text-pip font-bold drop-shadow-[0_0_5px_rgba(65,255,0,0.8)]">
                            GEOLOCATION
                        </span>
                    </div>
                );
    ...
    return (
        <div className="w-full h-screen flex flex-col bg-black font-mono relative p-4 sm:p-6 overflow-hidden">
            ...
            {/* TOP NAVIGATION */}
            <nav className="flex items-end border-b-2 border-pip pb-1 mb-2 px-2 sm:px-4 relative z-10">
            ...
            <footer className="h-12 flex justify-between items-center px-2 sm:px-6 text-pip font-bold text-lg sm:text-xl border-t-2 border-pip/50 mx-0 sm:mx-4 bg-black relative z-10 shrink-0">
                ...
                <div className="flex items-center gap-2">
                    <div className="bg-pip text-black px-1 text-sm">
                        HP
                    </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm sm:text-base w-16 text-right">
                        {Math.round(apCharge)}/100
                    </span>
