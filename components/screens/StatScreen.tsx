...
import { StatSubTab, Perk } from '../../types';
        ...
        <div className="relative z-10 h-48 w-48 max-h-[45vh] max-w-[45vh] sm:h-[32rem] sm:w-[32rem] sm:max-h-[70vh] sm:max-w-[70vh] flex items-center justify-center">
          ...
          {!imgError ? (
            <img
              ...
              style={{
                filter:
                  'brightness(0) saturate(100%) invert(58%) sepia(87%) saturate(365%) hue-rotate(101deg) brightness(92%) contrast(92%) drop-shadow-[0_0_2px_rgba(65,255,0,0.7)]',
                maskImage:
                  'repeating-linear-gradient(black, black 2px, transparent 3px)',
                WebkitMaskImage:
                  'repeating-linear-gradient(black, black 2px, transparent 3px)',
                opacity: 0.9
              }}
            ...
            <div className="flex flex-col items-center justify-center animate-flicker opacity-80 text-pip h-full w-full p-4">
              <User
                className="w-full h-full drop-shadow-[0_0_10px_rgba(65,255,0,0.8)]"
                strokeWidth={1}
              />
            </div>
          )}
...
const PerksView: React.FC = () => {
  ...
  const CurrentIcon =
    IconMap[selectedPerk.iconName] || Shield;
      ...
      <div className="flex flex-col md:flex-row h-full gap-4">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center p-4 text-pip">
          ...
          <div className="w-full border-2 border-pip p-4 bg-pip/5 rounded relative">
            ...
            <h3 className="text-xl font-bold mb-1 border-b border-pip/50 pb-2">
              {selectedPerk.name[contentLanguage]}
            </h3>
            ...
            <p className="text-lg mb-4">
              {selectedPerk.description[contentLanguage]}
            </p>
